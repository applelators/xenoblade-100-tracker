...
data.choices = [
  ...
  { part: 1, name: "Imaginations Tempered / Spirits Raised", opt: "mutually exclusive", shulk: "Imaginations Tempered (for the Lake Drop)", rpg: "Spirits Raised — more affinity + unlocks more later quests", c: true, id: "imaginations-spirits", picks: ["Imaginations Tempered", "Spirits Raised"], mine: "Spirits Raised. It opens a follow-up quest line (more quests to actually do), and ShulkLink's whole case for Imaginations is the affinity chart — which you've left out of your 100%. The Lake Drop it grants you can still farm freely at Raguel Lake." },
  ...
  { part: 1, name: "A Big Brother's Fight / A Little Brother's Fight", opt: "Zukazu (big) vs Jiroque (little)", shulk: "Big Brother (Zukazu)", rpg: "Little Brother (Jiroque) — slightly better affinity", c: true, id: "brother-fight", picks: ["Big Brother (Zukazu)", "Little Brother (Jiroque)"], mine: "Little Brother (Jiroque) — basically a tie. ShulkLink picks Zukazu only for a stronger affinity link (outside your 100%). Jiroque pays 7,500G (3× Zukazu's gold) + Jungle Bottoms; Zukazu gives more EXP + Jungle Top. Gold beats EXP since EXP caps — but honestly it's cosmetic." },
