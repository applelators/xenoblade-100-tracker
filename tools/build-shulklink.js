...
data.choices = [
  ...
  { part: 2, name: "Adventurers in Peril / The Missing Partner", opt: "mutually exclusive", shulk: "Adventurers in Peril — only it benefits the affinity chart", rpg: "The Missing Partner — better EXP/gold", c: true, id: "adventurers-partner", picks: ["Adventurers in Peril", "The Missing Partner"], mine: "Adventurers in Peril — it's available earlier (Part 2), gives a weapon (Black Sniper) plus affinity-chart changes; The Missing Partner gives only EXP/gold and explicitly no affinity benefit. More value, sooner." },
