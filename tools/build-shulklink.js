...
data.choices = [
  ...
  { part: 1, name: "Financial Planning", opt: "Leopold (frame King Squeeze) vs Sylvaine (investigate)", shulk: "Sylvaine", rpg: "Sylvaine", agree: "Sylvaine", agreeKey: "4.6:Q54b" },
  { part: 1, name: "Pestering Paola / Out-Of-Luck Giorgio", opt: "decided in Overworked & Underpaid — talk to Paola → unlocks Out-Of-Luck Giorgio (blue 'trusting family'); talk to Giorgio → Pestering Paola (yellow)", shulk: "Out-Of-Luck Giorgio (talk to Paola in Overworked & Underpaid) — the better, blue link", rpg: "Out-Of-Luck Giorgio — better affinity", agree: "Out-Of-Luck Giorgio (talk to Paola in Overworked & Underpaid)", agreeKey: "4.6:Q56b" },
  { part: 1, name: "Jackson's Awakening → Jackson the Poet / the Cook", opt: "Poet (Kenny Rohan) vs Cook (Giorgio)", shulk: "Poet (Kenny Rohan)", rpg: "Poet (Kenny Rohan)", agree: "Jackson the Poet (Kenny Rohan)", agreeKey: "4.7:Q94a" },
  { part: 1, name: "A Mysterious Light", opt: "two routes", shulk: "No strong preference", rpg: "Either" },
  { part: 1, name: "Out Like a Light?", opt: "Repair the lamp vs throw it away", shulk: "Throw it away (faster)", rpg: "Repair the lamp — better reward", c: true, id: "out-like-a-light", qmap: { "Repair the lamp": "4.7:Q96", "Throw it away": "4.7:Q96" }, picks: ["Repair the lamp", "Throw it away"], mine: "Throw it away. The guide itself calls the reward gap negligible, and repairing means farming Krabble Fixed Parts and waiting until you reach the Ether Mine. No real 100% loss." },
  { part: 1, name: "Imaginations Tempered / Spirits Raised", opt: "mutually exclusive", shulk: "Imaginations Tempered (for the Lake Drop)", rpg: "Spirits Raised — more affinity + unlocks more later quests", c: true, id: "imaginations-spirits", qmap: { "Imaginations Tempered": "4.6:Q87a", "Spirits Raised": "4.6:Q87b" }, picks: ["Imaginations Tempered", "Spirits Raised"], mine: "Imaginations Tempered. Since the affinity chart is part of your 100%, ShulkLink's detailed analysis wins: Imaginations gives the better/equal affinity outcome (Ewan & Matryona reach green — their best — and Spirits' sequels can only match it, not beat it) and does it right away. You'll hit the quest-count trials either way, so the few extra Spirits quests aren't decisive." },
  { part: 1, name: "Matryona's Answer", opt: "Lake drop vs nasty weed", shulk: "Lake drop", rpg: "Lake drop", agree: "the Lake Drop", agreeKey: "4.11:Q128" },
  { part: 1, name: "Desirée's Future", opt: "Soldier vs other career", shulk: "Soldier", rpg: "Soldier", agree: "Soldier", agreeKey: "4.11:Q130" },
  { part: 1, name: "A Big Brother's Fight / A Little Brother's Fight", opt: "Zukazu (big) vs Jiroque (little)", shulk: "Big Brother (Zukazu)", rpg: "Little Brother (Jiroque) — slightly better affinity", c: true, id: "brother-fight", qmap: { "Big Brother (Zukazu)": "4.14:Q184a", "Little Brother (Jiroque)": "4.14:Q184b" }, picks: ["Big Brother (Zukazu)", "Little Brother (Jiroque)"], mine: "Big Brother (Zukazu). With the affinity chart in your 100%, ShulkLink's pick is right: Zukazu lets the Jiroque/Zukazu link reach blue 'perfect brother' (their best) via the follow-up — and establishes a link you otherwise can't get. Jiroque's extra gold doesn't matter if you're completing the chart." },
  ...
  { part: 1, name: "Sweet Seduction / Ingredients for a Brew", opt: "Bitter Kiwi vs Walnut Grapes", shulk: "Bitter Kiwi (sell Walnut Grapes first — glitch)", rpg: "Bitter Kiwis", agree: "Bitter Kiwi", agreeKey: "4.14:Q167" },
  { part: 1, name: "How Do I Feel? → Together Forever / I Love You No Matter What", opt: "Rozael vs Ricoth", shulk: "Rozael (speak to him first)", rpg: "Rozael", agree: "Rozael", agreeKey: "4.20:Q236" },
  ...
  // ---- Part 2 (Ch. 11 – 15) ----
  { part: 2, name: "The Master's Successor", opt: "Gadada vs Cherri (sets Distilling/Safer Energy later)", shulk: "Cherri", rpg: "Cherri", agree: "Cherri", agreeKey: "4.22:Q298" },
  { part: 2, name: "Medical Advancements / Let's Make Fillings!", opt: "mutually exclusive (affinity identical)", shulk: "Let's Make Fillings (Yusa — better drop rates)", rpg: "Medical Advancements — more EXP/money", c: true, id: "medical-fillings", qmap: { "Medical Advancements": "4.22:Q280a", "Let's Make Fillings (Yusa)": "4.22:Q280b" }, picks: ["Medical Advancements", "Let's Make Fillings (Yusa)"], mine: "Let's Make Fillings (Yusa). Affinity is identical either way; the only real difference is the grind — Medical needs scarce Ories Horns, Fillings needs common Vang Milk Teeth. Easier to finish, and the extra gold/EXP from Medical is trivial." },
  ...
  { part: 2, name: "Getting Bigger! / Who Is Bigger?", opt: "Adidi vs other", shulk: "Adidi", rpg: "Adidi", agree: "Adidi", agreeKey: "4.22:Q286" },
  { part: 2, name: "Cook-Off Showdown!", opt: "ingredient approach", shulk: "“Make food your customers like”", rpg: "“Make food your customers like”", agree: "Make food your customers like", agreeKey: "4.22:Q270" },
  { part: 2, name: "Unstoppable Berryjammy", opt: "Norara vs other", shulk: "Norara", rpg: "Norara", agree: "Norara", agreeKey: "4.22:Q272" },
  { part: 2, name: "Miss Sweetness Showdown!", opt: "Berryjammy vs Ma'crish", shulk: "Either (inconsequential)", rpg: "Either" },
  { part: 2, name: "Adventurers in Peril / The Missing Partner", opt: "mutually exclusive", shulk: "Adventurers in Peril — only it benefits the affinity chart", rpg: "The Missing Partner — better EXP/gold", c: true, id: "adventurers-partner", qmap: { "Adventurers in Peril": "4.22:Q294", "The Missing Partner": "4.32:Q405" }, picks: ["Adventurers in Peril", "The Missing Partner"], mine: "Adventurers in Peril — it's available earlier (Part 2), gives a weapon (Black Sniper) plus affinity-chart changes; The Missing Partner gives only EXP/gold and explicitly no affinity benefit. More value, sooner." },
  ...
  { part: 3, name: "The Elite Captain's Anguish", opt: "Minnie vs other", shulk: "Minnie", rpg: "Minnie", agree: "Minnie", agreeKey: "4.32:Q401" },
